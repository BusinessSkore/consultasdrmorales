<template>
  ...
  <div class="gridEncontrar">
    <!-- Boton Agregar -->
    <!-- <button
      @click="this.$router.push(`/reclamos/new`)"
      type="button"
      class="btn btn-outline-success"
    >
      <i class="fas fa-plus" _mstvisible="2"></i> Agregar Reclamo
    </button> -->
    <!-- Campo de Búsqueda -->
    <div>
...
export default {
  props: ["filterReclamos", "search", "filteredReclamos"],
