...
export default defineComponent({
  ...
  async mounted() {
    ...
    // ];
    if (this.$route.fullPath == "/reclamosciru/new") {
      this.modoForm = "add";
  ...
  methods: {
    ...
    fixTime() {
      ...
      if (this.reclamo.ing) {
        this.reclamo.ing = this.formatDateToFix(this.reclamo.ing, false);
      }
      if (this.reclamo.egr) {
        this.reclamo.egr = this.formatDateToFix(this.reclamo.egr, false);
      }
