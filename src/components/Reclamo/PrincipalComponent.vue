<template v-show="!cargando">
  <!-- <p>Original: {{this.reclamosFiltradas}}</p><br/><br/> -->
  <!-- <p>Filtrado: {{this.reclamos}}</p><br/><br/> -->
          ...
          <div>
            ...
            <nav :class="navMenuClas2">
              <a
                ...
                ><i class="fas fa-file"></i> Registrar Consulta</a
              >
              <a
                class="navbar-option"
                href="#"
                @click="this.$router.push('/reclamosciru/new')"
          ...
          <div v-if="showModal" class="modal">
            <div class="contenedor">
              ...
              <div class="contenido">
                ...
                <div class="contenido">
                  <Filters
                    :filterReclamos="filterReclamos"
                    :search="search"
                    :filteredReclamos="filteredReclamos"
                  />
                </div>
              </div>
            </div>
...
.grid {
  ...
  grid-template-areas:
    ...
    "reclamos reclamos reclamos reclamos reclamos reclamos reclamos";
}
