<template>
  ...
  <body v-show="!cargando">
    <div class="grid-layout">
      ...
      <div class="caja c1">
        <h4 class="bold">{{ this.liga.medico }}</h4>
        <h5>{{ this.liga.direccion }}</h5>
        <!-- <h5>
          <span class="bold">RNC / Cédula: </span>
          <span>{{ this.liga.rncMedico }}</span>
        </h5> -->
        <h5>
      ...
      <div class="caja c2">
        <h3 class="bold">Liga<br /></h3>
        <h5>
          <span class="bold">No: </span>
          <span>{{ formatSecuence(liga.no) }}</span>
        </h5>
        <!-- <h5>
        ...
        <h5>
          ...
          <span>{{ formatDate(this.liga.fechaProceso) }}</span>
        </h5>
        <!-- <h5>
          <span class="bold">Vencimiento: </span>
          <span>{{ formatDate(this.liga.vencimiento) }}</span>
        </h5> -->
      </div>
      ...
      <div class="caja c3">
        <!-- <h5>
          ...
          <span>{{ this.liga.rncCliente }}</span>
        </h5> -->
        <h5>
          <span class="bold">Cliente: </span>
          <span>{{ this.liga.descCliente }}</span>
        </h5>
      </div>
      <div class="caja c4">
        <table class="table table-hover">
          ...
          <tr>
            <td class="t izq">{{ this.liga.descServicios }}</td>
            <td class="t der">
              {{ formatNumber(this.liga.preliga) }}
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="caja c6">
        <h6>{{ formatNumber(this.liga.preliga) }}</h6>
        <h6>{{ formatNumber(this.liga.descuento) }}</h6>
        <h6>{{ formatNumber(this.liga.descuento) }}</h6>
        <h6 class="bold">
          {{ formatNumber(this.liga.preliga) }}
        </h6>
