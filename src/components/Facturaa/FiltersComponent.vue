<template>
  ...
  <div class="gridEncontrar">
    ...
    >
      <i class="fas fa-plus" _mstvisible="2"></i> Agregar Facturaa
    </button> -->
    <!-- Campo de Búsqueda -->
    <div>
...
const filters = [
  ...
  "6 - Cargado a Facturaa",
  "7 - Enviado a la Aseguradora",
];

export default {
  props: ["filterFacturaas", "search", "filteredFacturaas"],
  ...
  methods: {
    toColor(type: string) {
      if (type == "1 - Recibido por Auditoría Interna") {
        ...
        return "valor5";
      } else if (type == "6 - Cargado a Facturaa") {
        return "valor6";
...
.RecibidoporAuditoría {
  text-align: center;
  background-color: rgb(250, 148, 115);
  margin: 1px;
  color: white;
}

.VerificadoporAuditoríaInterna {
  text-align: center;
  background-color: rgb(252, 191, 123);
  margin: 1px;
  color: white;
}

.VerificadoporAuditoríaExterna {
  text-align: center;
...
.VerificadoporReclamacionesMédicas {
  text-align: center;
  background-color: rgb(204, 221, 130);
  margin: 1px;
  color: white;
}
