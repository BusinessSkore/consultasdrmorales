<template>
  ...
  <div class="flex-container">
    <div>
      <img style="width: 150px;" src="@/assets/images/logoSQR.png" />
  ...
  <div class="flex-container">
    <div style="width: 60%">
      <label style="font-weight: bold">CERTIFICADO MEDICO</label>
      <div>
        <!-- <p style="font-size: 80%">{{ licencia.licencia }}</p> -->
    ...
    <div class="flex-container">
      ...
      <div>
        ...
        <p style="font-size: 80%; text-align: right;">
          {{ formatDate2(licencia.fechaActual) }}
        </p>
      </div>
    </div>
  </div>
