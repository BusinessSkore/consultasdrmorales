      ...
      <!-- <div v-if="showModal" class="modal">
        <div class="contenedor">
          ...
          <div class="contenido">
            ...
            <div class="contenido">
              <Filters
                :filterExpedientes="filterExpedientes"
                :search="search"
...
<script lang="ts">
import Filters from "@/components/Expediente/FiltersComponent.vue";
...
export default {
  ...
  methods: {
    ...
    async filterExpedientes(catName: string) {
      try {
      ...
      if (catName !== "Todos") {
        this.expedientes = this.expedientes.filter((expediente: Expediente) => {
          return expediente.sexo === catName;
        });
      }
    },
...
.grid {
  ...
  grid-template-areas:
    ...
    "expedientes expedientes expedientes expedientes expedientes expedientes expedientes";
}
