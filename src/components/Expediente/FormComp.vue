        ...
        <form>
          <fieldset>
              ...
              <div class="grid">
                ...
                <div>
                  ...
                  ><input
                    id="fechaActual"
                    type="datetime-local"
                    v-model="expediente.fechaActual"
                    class="form-control"
                  />
                </div>
                ...
                <div>
                  ...
                  ><input
                    @change="calcularEdad(expediente.fechaNacimiento)"
                    id="fechaNacimiento"
                    type="Date"
                ...
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="ladoDominante"
                    >Lado Dominante:</label
                  ><input
                    id="ladoDominante"
                    type="ladoDominante"
                    v-model="expediente.ladoDominante"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    id="referidoPor"
                    type="referidoPor"
                    v-model="expediente.referidoPor"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                ...
                <div>
                  ...
                  ><textarea
                    ...
                    id="habitosToxicos"
                    type="habitosToxicos"
                    v-model="expediente.habitosToxicos"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><textarea
                    ...
                    id="antQuirurgicos"
                    type="antQuirurgicos"
                    v-model="expediente.antQuirurgicos"
                    class="form-control"
                  />
                </div>
                <div>
              ...
              <div class="grid-3">
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="expediente.mecanismoLesion"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.tiempoEvolucion"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.elevacionAnteriorActiva"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.elevacionAnteriosPasiva"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.rotacionInterna"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.rotacionExterna"
                    class="form-control"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.acromioClavicular"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.inestabilidadAnterior"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="expediente.inestabilidadPosterior"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                <div>
                  ...
                  ><input
                    id="cajonAnterior"
                    type="cajonAnterior"
                    v-model="expediente.cajonAnterior"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    id="cajonPosterior"
                    type="cajonPosterior"
                    v-model="expediente.cajonPosterior"
                    class="form-control"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  ><input
                    id="bostezoLateral"
                    type="bostezoLateral"
                    v-model="expediente.bostezoLateral"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    id="bostezoMedial"
                    type="bostezoMedial"
                    v-model="expediente.bostezoMedial"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="expediente.estudiosSolicitados"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                ...
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="expediente.diagnosticoImagen"
                    class="form-control"
                  />
                </div>
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="diagnosticoImagen"
                    >Diagnóstico Aseguradora:</label
                  ><input
                    id="diagnosticoImagen"
                    type="diagnosticoImagen"
                    v-model="expediente.dxReclam"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="grid">
                <div>
                  ...
                  ><textarea
                    ...
                    id="medicamentos"
                    type="medicamentos"
                    v-model="expediente.medicamentos"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><textarea
                    ...
                    id="terapiaFisica"
                    type="terapiaFisica"
                    v-model="expediente.terapiaFisica"
                    class="form-control"
                  />
                </div>
                <div>
            ...
            <div class="grid-consultas">
              <!-- <ul>
                <li
                  v-for="(consulta, index) in expediente.consultas"
                  :key="index"
                >
                  <a href="#">
                    <h2>
            ...
            <label class="form-label"
              ><b
                style="cursor:pointer"
                @click="this.$router.push(`/recetas/new`)"
              >
                Recetas
                <i class="fas fa-plus" _mstvisible="2"></i></b
            ></label>
            <div class="grid">
              <div
                v-for="(receta, index) in recetas"
                :key="index"
                @click="this.$router.push(`/recetas/${receta._id}`)"
                class="card-body"
                style="cursor: pointer"
              >
                <p style="font-weight: bold">
                  No. {{ index + 1 }} -
                  {{ newFormatDate(receta.fechaActual) }}
                </p>
            ...
            <label class="form-label"
              ><b
                style="cursor:pointer"
                @click="this.$router.push(`/licencias/new`)"
              >
                Licencias
                <i class="fas fa-plus" _mstvisible="2"></i></b
            ></label>
            <div class="grid">
              <div
                v-for="(licencia, index) in licencias"
                :key="index"
                @click="this.$router.push(`/licencias/${licencia._id}`)"
                class="card-body"
                style="cursor: pointer"
              >
                <p style="font-weight: bold">
                  No. {{ index + 1 }} -
                  {{ newFormatDate(licencia.fechaActual) }}
                </p>
            ...
            <button
              ...
              @click.prevent="saveExpediente()"
              :disabled="
                !expediente.nombre ||
                  !expediente.fechaActual ||
            ...
            <button
              ...
              @click="this.$router.push(`/expedientes2/${expediente._id}`)"
            >
