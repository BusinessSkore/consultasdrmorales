<template>
  ...
  <div class="gridEncontrar">
    <!-- Boton Agregar -->
    <!-- <button
      @click="this.$router.push(`/expedientes/new`)"
      type="button"
      class="btn btn-outline-success"
    >
      <i class="fas fa-plus" _mstvisible="2"></i> Agregar Expediente
    </button> -->
    <!-- Campo de Búsqueda -->
    <div>
  ...
  <!-- <div>
    ...
    <div class="gridposts">
      <p
        ...
        :key="filter"
        @click="() => filterExpedientes(filter)"
      >
        {{ filter }}
      </p>
    </div>
...
export default {
  props: ["filterExpedientes", "search", "filteredExpedientes"],
